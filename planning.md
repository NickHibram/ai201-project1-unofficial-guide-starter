...
|---|----------|-----------------|--------------------|
| 1 | What is the Japanese koto, and how is it played? | It is derived from the Chinese Sê; it has movable bridges and no stops, pentatonic tuning, and is played kneeling with plectra while the other hand changes string tension. | *Musical Instruments, Historic, Rare and Unique* |
| 2 | According to the violin handbook, what are violin strings made from, and what alternative does it name? | The handbook discusses good-quality gut strings; it names silk “Acribelles” first strings as a moisture-resistant alternative with poorer tone. | *Handbook of Violin Playing* |
| 3 | According to Hofmann, how is true legato piano touch produced? | Keep fingers nearly in contact with the keys, glide between notes, touch the next key before releasing the previous one, and use practical fingering to keep runs connected. | *Piano Playing, with Piano Questions Answered* |
| 4 | What are coach-horns typically used for, and how does that differ from post-horns? | Coach-horns are used for a four-in-hand; post-horns were the recognized signal horns used by guards on mail coaches. | *The Coach-Horn* |
| 5 | How often should bagpipes be cleaned? | Clean them thoroughly at least once a month, or once a week when they are played frequently. | *The Highland Bagpipe* |
